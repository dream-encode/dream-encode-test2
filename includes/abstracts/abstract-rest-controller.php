<?php
/**
 * Class Dream_Encode_Test_Abstract_REST_Controller
 */

namespace Dream_Encode\Test\Core\Abstracts;

use WP_REST_Controller;
use Dream_Encode\Test\Core\RestApi\Dream_Encode_Test_REST_Authentication;

/**
 * Class Dream_Encode_Test_Abstract_REST_Controller
 */
class Dream_Encode_Test_Abstract_REST_Controller extends WP_REST_Controller {
	/**
	 ...
	 */
	public $namespace = 'dream-encode/v1';
	...
	public function check_admin_permission() {
		return Dream_Encode_Test_REST_Authentication::check_admin_permission();
	}
	...
	public function check_user_permission() {
		return Dream_Encode_Test_REST_Authentication::check_user_permission();
	}
}
